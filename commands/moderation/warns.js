function warn(message,prefix,client,fs,path){

let warns = JSON.parse(fs.readFileSync(path.resolve(__dirname, ("../../data/warns.json"))));
      ...
      if (message.mentions.users.size != 0) {
        if (args[0] === "<@!"+mentioned.id+">"||args[0] === "<@"+mentioned.id+">") {
          if (args.slice(1).length != 0) {
            ...
            fs.writeFile(path.resolve(__dirname, ("../../data/warns.json")), JSON.stringify(warns), (err) => {if (err) console.error(err);});
message.delete();
